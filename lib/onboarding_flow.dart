...
import 'package:navigation_pop_issue/webview.dart';
...
class OnboardingUsage extends StatefulWidget {
  static Page page() => MyPage<void>(child: OnboardingUsage());

  @override
  _OnboardingUsageState createState() => _OnboardingUsageState();
}
...
class MyPage<T> extends Page<T> {
  const MyPage({this.child, LocalKey key}) : super(key: key);
